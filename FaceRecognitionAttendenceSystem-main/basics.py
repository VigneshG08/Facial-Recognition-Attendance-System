...
def mark_attendance(allstudents):
    date = datetime.now().strftime('%Y-%m-%d')
    ...
    with open(attendance_file, 'a', newline='') as csvfile:
        ...
        for student_name in allstudents:
            writer.writerow({'Date': date, 'Time': time_stamp, 'Student_ID':allstudents[student_name], 'Student_Name': student_name})
